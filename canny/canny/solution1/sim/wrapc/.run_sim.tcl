...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "canny.autotvin.dat"
	set constFileTvOut       "canny.autotvout.dat"
	set constFileHdlTvIn     "canny.autohdltvin.dat"
	set constFileHdlTvOut    "canny.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
