...
`define TV_OUT_dst_TDATA "../tv/rtldatafile/rtl.canny.autotvout_dst.dat"
...
module AESL_axi_s_dst (
    ...
    reg [32 - 1:0] dst_TDATA_write_data;
    reg dst_TDATA_read_en;
    wire [32 - 1:0] dst_TDATA_read_data;
    
    fifo #(17000, 32) fifo_dst_TDATA (
        .reset(1'b0),
        .write_clock(clk),
