set moduleName dut_Pipeline_VITIS_LOOP_177_14
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_177_14}
set C_modelType { void 0 }
set C_modelArgList {
	{ select_ln22_1 int 6 regular  }
	{ gmem int 8 regular {axi_master 2}  }
	{ add_ln177 int 64 regular  }
	{ src_buff int 64 regular  }
	{ skip_row_arr int 32 regular {array 1000 { 1 3 } 1 1 }  }
	{ select_ln177 int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "select_ln22_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln177", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln22_1 sc_in sc_lv 6 signal 0 } 
	{ add_ln177 sc_in sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln22_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "select_ln22_1", "role": "default" }} , 
 	{ "name": "add_ln177", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln177", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_177_14",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1014", "EstimateLatencyMax" : "1014",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set Spec2ImplPortList { 
	select_ln22_1 { ap_none {  { select_ln22_1 in_data 0 6 } } }
	...
	add_ln177 { ap_none {  { add_ln177 in_data 0 64 } } }
