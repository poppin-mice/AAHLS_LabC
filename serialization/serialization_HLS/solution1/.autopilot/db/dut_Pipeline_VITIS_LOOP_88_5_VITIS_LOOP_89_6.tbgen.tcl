set moduleName dut_Pipeline_VITIS_LOOP_88_5_VITIS_LOOP_89_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_88_5_VITIS_LOOP_89_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst_counter_1_reload int 32 regular  }
	...
	{ dst_counter_4_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst_counter_1_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_counter_4_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ dst_counter_1_reload sc_in sc_lv 32 signal 0 } 
	{ skip_row_arr_address0 sc_out sc_lv 10 signal 2 } 
	{ skip_row_arr_ce0 sc_out sc_logic 1 signal 2 } 
	{ skip_row_arr_q0 sc_in sc_lv 32 signal 2 } 
	{ icmp_ln31 sc_in sc_lv 1 signal 3 } 
	{ select_ln63 sc_in sc_lv 7 signal 4 } 
	{ dst_buff sc_in sc_lv 64 signal 5 } 
	{ src_buff sc_in sc_lv 64 signal 6 } 
	{ dst_counter_4_out sc_out sc_lv 32 signal 7 } 
	{ dst_counter_4_out_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_counter_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_1_reload", "role": "default" }} , 
 	...
 	{ "name": "dst_counter_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_4_out", "role": "default" }} , 
 	{ "name": "dst_counter_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst_counter_4_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_88_5_VITIS_LOOP_89_6",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "8020", "EstimateLatencyMax" : "8020",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "dst_counter_1_reload", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "dst_counter_4_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_88_5_VITIS_LOOP_89_6", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	dut_Pipeline_VITIS_LOOP_88_5_VITIS_LOOP_89_6 {
		dst_counter_1_reload {Type I LastRead 0 FirstWrite -1}
		...
		dst_counter_4_out {Type O LastRead -1 FirstWrite 19}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8020", "Max" : "8020"}
	, {"Name" : "Interval", "Min" : "8020", "Max" : "8020"}
]}
...
set Spec2ImplPortList { 
	dst_counter_1_reload { ap_none {  { dst_counter_1_reload in_data 0 32 } } }
	...
	dst_counter_4_out { ap_vld {  { dst_counter_4_out out_data 1 32 }  { dst_counter_4_out_ap_vld out_vld 1 1 } } }
}
