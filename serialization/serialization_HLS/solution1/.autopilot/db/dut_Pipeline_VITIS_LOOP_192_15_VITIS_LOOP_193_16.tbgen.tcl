set moduleName dut_Pipeline_VITIS_LOOP_192_15_VITIS_LOOP_193_16
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_192_15_VITIS_LOOP_193_16}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln177_1 int 32 regular  }
	{ gmem int 8 regular {axi_master 1}  }
	{ dst_buff int 64 regular  }
	{ var_string_length int 32 regular {array 1000 { 1 3 } 1 1 }  }
	{ dst_counter_20_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "add_ln177_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "var_string_length", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "dst_counter_20_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ add_ln177_1 sc_in sc_lv 32 signal 0 } 
	{ dst_buff sc_in sc_lv 64 signal 2 } 
	{ var_string_length_address0 sc_out sc_lv 10 signal 3 } 
	{ var_string_length_ce0 sc_out sc_logic 1 signal 3 } 
	{ var_string_length_q0 sc_in sc_lv 32 signal 3 } 
	{ dst_counter_20_out sc_out sc_lv 32 signal 4 } 
	{ dst_counter_20_out_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln177_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "add_ln177_1", "role": "default" }} , 
 	{ "name": "dst_buff", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dst_buff", "role": "default" }} , 
 	{ "name": "var_string_length_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "var_string_length", "role": "address0" }} , 
 	{ "name": "var_string_length_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "var_string_length", "role": "ce0" }} , 
 	{ "name": "var_string_length_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "var_string_length", "role": "q0" }} , 
 	{ "name": "dst_counter_20_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_20_out", "role": "default" }} , 
 	{ "name": "dst_counter_20_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst_counter_20_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_192_15_VITIS_LOOP_193_16",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4013", "EstimateLatencyMax" : "4013",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "add_ln177_1", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "var_string_length", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "dst_counter_20_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_192_15_VITIS_LOOP_193_16", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter9", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter9", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	dut_Pipeline_VITIS_LOOP_192_15_VITIS_LOOP_193_16 {
		add_ln177_1 {Type I LastRead 0 FirstWrite -1}
		gmem {Type O LastRead 5 FirstWrite 4}
		dst_buff {Type I LastRead 0 FirstWrite -1}
		var_string_length {Type I LastRead 1 FirstWrite -1}
		dst_counter_20_out {Type O LastRead -1 FirstWrite 8}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4013", "Max" : "4013"}
	, {"Name" : "Interval", "Min" : "4013", "Max" : "4013"}
]}
...
set Spec2ImplPortList { 
	add_ln177_1 { ap_none {  { add_ln177_1 in_data 0 32 } } }
	...
	var_string_length { ap_memory {  { var_string_length_address0 mem_address 1 10 }  { var_string_length_ce0 mem_ce 1 1 }  { var_string_length_q0 mem_dout 0 32 } } }
	dst_counter_20_out { ap_vld {  { dst_counter_20_out out_data 1 32 }  { dst_counter_20_out_ap_vld out_vld 1 1 } } }
}
