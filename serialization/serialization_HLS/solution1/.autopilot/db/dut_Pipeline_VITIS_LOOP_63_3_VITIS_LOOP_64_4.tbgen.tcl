set moduleName dut_Pipeline_VITIS_LOOP_63_3_VITIS_LOOP_64_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_63_3_VITIS_LOOP_64_4}
...
set C_modelArgList {
	...
	{ dst_counter_1_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "src_buff","offset": { "type": "dynamic","port_name": "src_buff","bundle": "control"},"direction": "READONLY"},{"cName": "dst_buff","offset": { "type": "dynamic","port_name": "dst_buff","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "dst_counter_1_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ skip_row_arr_address0 sc_out sc_lv 10 signal 1 } 
	{ skip_row_arr_ce0 sc_out sc_logic 1 signal 1 } 
	{ skip_row_arr_q0 sc_in sc_lv 32 signal 1 } 
	{ icmp_ln31 sc_in sc_lv 1 signal 2 } 
	{ select_ln63 sc_in sc_lv 7 signal 3 } 
	{ dst_buff sc_in sc_lv 64 signal 4 } 
	{ src_buff sc_in sc_lv 64 signal 5 } 
	{ dst_counter_1_out sc_out sc_lv 32 signal 6 } 
	{ dst_counter_1_out_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_counter_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_1_out", "role": "default" }} , 
 	{ "name": "dst_counter_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst_counter_1_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_63_3_VITIS_LOOP_64_4",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "dst_counter_1_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_63_3_VITIS_LOOP_64_4", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	dut_Pipeline_VITIS_LOOP_63_3_VITIS_LOOP_64_4 {
		...
		dst_counter_1_out {Type O LastRead -1 FirstWrite 19}}}
...
set Spec2ImplPortList { 
	...
	dst_counter_1_out { ap_vld {  { dst_counter_1_out out_data 1 32 }  { dst_counter_1_out_ap_vld out_vld 1 1 } } }
}
