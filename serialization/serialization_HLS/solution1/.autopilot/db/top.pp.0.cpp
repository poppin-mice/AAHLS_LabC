...
# 1 "top.cpp" 2
# 1 "./top.hpp" 1
const int SRC_INTERFACE_SZ = 660000;
const int DST_INTERFACE_SZ = 660000;
# 13 "./top.hpp"
__attribute__((sdx_kernel("dut", 0))) void dut(char* src_buff, int src_sz, char* dst_buff);
# 2 "top.cpp" 2
...
__attribute__((sdx_kernel("dut", 0))) void dut(char* src_buff, int src_sz, char* dst_buff) {
#line 22 "C:/Users/edan/Desktop/serialization/serialization_HLS/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=dut
# 4 "top.cpp"

#line 6 "C:/Users/edan/Desktop/serialization/serialization_HLS/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=dut
# 4 "top.cpp"

#line 7 "C:/Users/edan/Desktop/serialization/serialization_HLS/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE m_axi depth=120000 port=src_buff
# 4 "top.cpp"

#line 8 "C:/Users/edan/Desktop/serialization/serialization_HLS/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE m_axi depth=120000 port=dst_buff
# 4 "top.cpp"
 ...
 if (pattern > 1) {
  ...
  VITIS_LOOP_37_1: for(unsigned int i = 0; i < 1000; i++) {
   total_length = 0;
   skip_row = 0;
   VITIS_LOOP_40_2: while (src_buff[src_counter+2] == data_id)
   {
 ...
 if (pattern == 1 || pattern == 3) {
  VITIS_LOOP_63_3: for(unsigned int i = 0; i < 1000; i++) {
   VITIS_LOOP_64_4: for (unsigned int j = 0; j < 8; j ++) {
    if (j < 3) {
  ...
  counter = 0;
  src_counter = 11;
  VITIS_LOOP_88_5: for(unsigned int i = 0; i < 1000; i++) {
   VITIS_LOOP_89_6: for (unsigned int j = 0; j < 8; j ++) {
    if (j < 1) {
     dst_buff[dst_counter + j] = src_buff[src_counter+10-j];
    } else {
     dst_buff[dst_counter + j] = 0;
  ...
  counter = 0;
  src_counter = 22;
  VITIS_LOOP_112_7: for(unsigned int i = 0; i < 1000; i++) {
   VITIS_LOOP_113_8: for (unsigned int j = 0; j < 8; j ++) {
    dst_buff[dst_counter + j] = src_buff[src_counter+10-j];
    if (j == 7) {
     if (pattern > 1) {
      src_counter += skip_row_arr[counter]*11;
  ...
  counter = 0;
  src_counter = 33;
  VITIS_LOOP_132_9: for(unsigned int i = 0; i < 1000; i++) {
   VITIS_LOOP_133_10: for (unsigned int j = 0; j < 8; j ++) {
    dst_buff[dst_counter + j] = src_buff[src_counter+10-j];
    if (j == 7) {
     if (pattern > 1) {
      src_counter += skip_row_arr[counter]*11;
 ...
 if (pattern == 2 || pattern == 3) {
  ...
  VITIS_LOOP_153_11: for(unsigned int i = 0; i < 1001; i++) {
   VITIS_LOOP_154_12: for (unsigned int j = 0; j < 4; j ++) {
  ...
  VITIS_LOOP_164_13: for (unsigned int j = 0; j < 4; j ++) {
   dst_buff[dst_counter + j] = 0;
   if (j == 3) {
    dst_counter += 4;
   }
  ...
  VITIS_LOOP_177_14: for(unsigned int i = 0; i < 1000; i++) {
  ...
  position = 0;
  counter = 0;
  VITIS_LOOP_192_15: for(unsigned int i = 0; i < 1001; i++) {
   VITIS_LOOP_193_16: for (unsigned int j = 0; j < 4; j ++) {
    dst_buff[dst_counter + j] = (position >> (j << 3)) & 0xff;
    if (j == 3) {
     dst_counter += 4;
     if (i < 1000) {
  ...
  VITIS_LOOP_204_17: for (unsigned int j = 0; j < 4; j ++) {
   dst_buff[dst_counter + j] = 0;
   if (j == 3) {
    dst_counter += 4;
   }
  ...
  VITIS_LOOP_223_18: for(unsigned int i = 0; i < 1000; i++) {

   VITIS_LOOP_225_19: for(unsigned int j = 0; j < current_skip_row+1; j++) {
    if (j == 0) {
     current_skip_row = skip_row_arr[counter];
     current_total_num = var_string_length[counter];
    }
    if (j == current_skip_row) {
     VITIS_LOOP_231_20: for (unsigned int k = 0; k < current_total_num; k++) {
     ...
     VITIS_LOOP_245_21: for (unsigned int k = 0; k < 8; k++) {
#pragma HLS unroll
