set moduleName dut_Pipeline_VITIS_LOOP_40_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_40_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ src_counter int 32 regular  }
	{ gmem int 8 regular {axi_master 0}  }
	{ src_buff int 64 regular  }
	{ select_ln50 int 3 regular  }
	{ total_length_out int 32 regular {pointer 1}  }
	{ src_counter_1_out int 32 regular {pointer 1}  }
	{ skip_row_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_counter", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "src_buff","offset": { "type": "dynamic","port_name": "src_buff","bundle": "control"},"direction": "READONLY"},{"cName": "dst_buff","offset": { "type": "dynamic","port_name": "dst_buff","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "src_buff", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln50", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "total_length_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "src_counter_1_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "skip_row_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ src_counter sc_in sc_lv 32 signal 0 } 
	...
	{ select_ln50 sc_in sc_lv 3 signal 3 } 
	{ total_length_out sc_out sc_lv 32 signal 4 } 
	{ total_length_out_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ src_counter_1_out sc_out sc_lv 32 signal 5 } 
	{ src_counter_1_out_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ skip_row_out sc_out sc_lv 32 signal 6 } 
	{ skip_row_out_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "src_counter", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "src_counter", "role": "default" }} , 
 	...
 	{ "name": "select_ln50", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "select_ln50", "role": "default" }} , 
 	{ "name": "total_length_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "total_length_out", "role": "default" }} , 
 	{ "name": "total_length_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "total_length_out", "role": "ap_vld" }} , 
 	{ "name": "src_counter_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "src_counter_1_out", "role": "default" }} , 
 	{ "name": "src_counter_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "src_counter_1_out", "role": "ap_vld" }} , 
 	{ "name": "skip_row_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "skip_row_out", "role": "default" }} , 
 	{ "name": "skip_row_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "skip_row_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_40_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "src_counter", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem_blk_n_AR", "Type" : "RtlSignal"},
					{"Name" : "gmem_blk_n_R", "Type" : "RtlSignal"}]},
			{"Name" : "src_buff", "Type" : "None", "Direction" : "I"},
			{"Name" : "select_ln50", "Type" : "None", "Direction" : "I"},
			{"Name" : "total_length_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "src_counter_1_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "skip_row_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	dut_Pipeline_VITIS_LOOP_40_2 {
		src_counter {Type I LastRead 0 FirstWrite -1}
		gmem {Type I LastRead 17 FirstWrite -1}
		src_buff {Type I LastRead 0 FirstWrite -1}
		select_ln50 {Type I LastRead 0 FirstWrite -1}
		total_length_out {Type O LastRead -1 FirstWrite 9}
		src_counter_1_out {Type O LastRead -1 FirstWrite 9}
		skip_row_out {Type O LastRead -1 FirstWrite 9}}}
...
set Spec2ImplPortList { 
	src_counter { ap_none {  { src_counter in_data 0 32 } } }
	...
	select_ln50 { ap_none {  { select_ln50 in_data 0 3 } } }
	total_length_out { ap_vld {  { total_length_out out_data 1 32 }  { total_length_out_ap_vld out_vld 1 1 } } }
	src_counter_1_out { ap_vld {  { src_counter_1_out out_data 1 32 }  { src_counter_1_out_ap_vld out_vld 1 1 } } }
	skip_row_out { ap_vld {  { skip_row_out out_data 1 32 }  { skip_row_out_ap_vld out_vld 1 1 } } }
}
