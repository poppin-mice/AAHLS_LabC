set moduleName dut_Pipeline_VITIS_LOOP_164_13
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_164_13}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst_counter_15_reload int 32 regular  }
	{ gmem int 8 regular {axi_master 1}  }
	{ dst_buff int 64 regular  }
	{ dst_counter_18_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst_counter_15_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_counter_18_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ dst_counter_15_reload sc_in sc_lv 32 signal 0 } 
	{ dst_buff sc_in sc_lv 64 signal 2 } 
	{ dst_counter_18_out sc_out sc_lv 32 signal 3 } 
	{ dst_counter_18_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_counter_15_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_15_reload", "role": "default" }} , 
 	{ "name": "dst_buff", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dst_buff", "role": "default" }} , 
 	{ "name": "dst_counter_18_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_counter_18_out", "role": "default" }} , 
 	{ "name": "dst_counter_18_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "dst_counter_18_out", "role": "ap_vld" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "dut_Pipeline_VITIS_LOOP_164_13",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "dst_counter_15_reload", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "dst_counter_18_out", "Type" : "Vld", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_164_13", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter1", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter8", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter8", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	dut_Pipeline_VITIS_LOOP_164_13 {
		dst_counter_15_reload {Type I LastRead 0 FirstWrite -1}
		gmem {Type O LastRead 4 FirstWrite 3}
		dst_buff {Type I LastRead 0 FirstWrite -1}
		dst_counter_18_out {Type O LastRead -1 FirstWrite 7}}}
...
set Spec2ImplPortList { 
	dst_counter_15_reload { ap_none {  { dst_counter_15_reload in_data 0 32 } } }
	...
	dst_counter_18_out { ap_vld {  { dst_counter_18_out out_data 1 32 }  { dst_counter_18_out_ap_vld out_vld 1 1 } } }
}
