...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_src_counter \
    op interface \
    ports { src_counter { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln50 \
    op interface \
    ports { select_ln50 { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name total_length_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_total_length_out \
    op interface \
    ports { total_length_out { O 32 vector } total_length_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name src_counter_1_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_src_counter_1_out \
    op interface \
    ports { src_counter_1_out { O 32 vector } src_counter_1_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_skip_row_out \
    op interface \
    ports { skip_row_out { O 32 vector } skip_row_out_ap_vld { O 1 bit } } \
} "
}
