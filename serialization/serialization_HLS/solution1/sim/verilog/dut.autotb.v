...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.dut.autotvin_gmem.dat"
...
`define AUTOTB_TVIN_dst_buff_out_wrapc  "../tv/rtldatafile/rtl.dut.autotvin_dst_buff.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.dut.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.dut.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_src_buff = 1;
parameter LENGTH_src_sz = 1;
parameter LENGTH_dst_buff = 1;
parameter LENGTH_gmem = 240000;
...
// The signal of port src_sz
reg [31: 0] AESL_REG_src_sz = 0;
assign src_sz = AESL_REG_src_sz;
initial begin : read_file_process_src_sz
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 1);
    fp = $fopen(`AUTOTB_TVIN_src_sz,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_src_sz);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_src_sz);
              if (ret != 1) begin
